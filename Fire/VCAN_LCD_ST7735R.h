...
/********************* ST7735R内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735R_WR      LCD_WR
#define     LCD_ST7735R_RD      LCD_RD
#define     LCD_ST7735R_CS      LCD_CS
#define     LCD_ST7735R_RS      LCD_RS
#define     LCD_ST7735R_RST     LCD_RST 

//此部分需要修改初始化里的代码
#define     LCD_ST7735R_P0              LCD_Date_Out
#define     LCD_ST7735R_PIN             LCD_Date_IN
